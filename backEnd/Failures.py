...
failure_codes = [QUERY_TERMINATE_CODE, END_OF_BASIN_CODE, QUERY_FAILURE_CODE, EDGE_OF_DATASET_CODE, QUERY_PARSE_FAILURE_CODE, EMPTY_QUERY_CODE, SNAP_FAILURE_CODE, NO_SITEID_GAP_CODE]
