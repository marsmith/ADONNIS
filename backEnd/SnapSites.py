...
def getSiteStreamNameIdentifier (siteName):
    """ Gets a key string from the site name that could be used to help snap site.
    
    :param siteName: The full name of a site.
    
    :return: The identifier. Should be the name of the stream the site is on if all goes correctly.  """
...
def snapPoint(snapablePoint, baseData, snapCutoff = CUTOFF_DIST):
    """ Snap a point to stream data.
    
    :param baseData: Expected to be a baseData object.
    :param snapCutoff: Distance of nearest snap point at which point an error will be thrown.
    
    :return: a Snap instance """
...
def getSiteSnapAssignment (graph, assignBadSites = False):
    """ Gets assignments for sites associated with a graph. 

    WARNING: this function will modify 'graph'. Always follow the calling of this function by assigning the 
    site snaps generated by the function.
    
    :param graph: The graph to use. WARNING: graph may be modified during this method. 
    :param assignBadSites: Add assignments of sites with warnings?
    
    :return: a list of GraphSite instances. """
